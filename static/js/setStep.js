...
SetStep.prototype.init=function(arg){
    ...
    var stepP=$("<div class='ystep-progress'>"+
            ...
            "</div>");
    var stepButtonHtml =$( "<div class='step-button'><button type='button' class='btn btn-default nextBtn' id='nextBtn' class='nextBtn'>下一步</button></div>");
